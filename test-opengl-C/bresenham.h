...
#ifndef TEST_OPENGL_C_BRESENHAM_C_H
#define TEST_OPENGL_C_BRESENHAM_C_H

#endif //TEST_OPENGL_C_BRESENHAM_C_H
#include<GL/glut.h>
#include<stdlib.h>
#include <stdio.h>
...
int runMain2(int argc, char **argv)
{
    printf("Enter the coordinates\n");
    scanf("%d%d%d%d",&cor_1,&cor_2,&cor_3,&cor_4);
    glutInit(&argc, argv);
